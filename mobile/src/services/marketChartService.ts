...
export const chartMarketForEvent = (event: Event): Market | undefined =>
  event.markets.find((market) => market.type !== "prop" && market.type !== "future" && market.marketType === "moneyline") ??
  event.markets.find((market) => market.type !== "prop" && market.type !== "future" && market.marketType !== "to_advance") ??
