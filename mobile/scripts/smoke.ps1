...
try {
  ...
  if ($ServerOrderSuccess) {
    if (-not $env:EXPO_PUBLIC_API_KEY) {
      throw "EXPO_PUBLIC_API_KEY is required for ServerOrderSuccess smoke."
    }
    $env:EXPO_PUBLIC_ORDER_MODE = "server"
