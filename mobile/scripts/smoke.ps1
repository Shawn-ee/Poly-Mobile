...
try {
  ...
  if ($ServerUnavailable -or $ServerOrderFailure -or $ServerCloseFixture -or $AccountProfileSyncError) {
  ...
  } elseif ($ServerPortfolioFixture -or $ServerCloseFixture) {
