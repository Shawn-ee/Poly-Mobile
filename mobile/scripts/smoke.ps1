...
try {
  ...
  if ($ServerUnavailable -or $ServerOrderFailure -or $ServerCloseFixture -or $ServerPositionTrade -or $AccountProfileSyncError) {
  ...
  } elseif ($ServerPortfolioFixture -or $ServerCloseFixture -or $ServerPositionTrade) {
