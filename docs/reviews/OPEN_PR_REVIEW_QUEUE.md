...
| #177 | `docs: refresh UI post-merge state` | Docs-only state refresh | Low by file type, stale by content | Close or update, do not merge as-is | Targets older checkpoint `8db1fd7`; current `dev` is `97c00e0` and includes later state-refresh docs through PR #212. |
| #192 | `docs: refresh autonomous checkpoint after pr191` | Draft docs-only checkpoint | Low by file type, stale by content | Close or update, do not merge as-is | Superseded by merged PR #193 and reflected in later queue/checkpoint refreshes through PR #212 on current `dev` checkpoint `97c00e0`. |
| #198 | `docs: refresh checkpoint after pr196` | Draft docs-only checkpoint | Low by file type, stale by content | Close or update, do not merge as-is | Superseded by merged PR #199, PR #200, PR #197, PR #201, PR #202, PR #204, PR #208, PR #203, PR #209, PR #211, and PR #212 on current `dev` checkpoint `97c00e0`. |
| #205 | `docs: refresh checkpoint after pr204` | Draft docs-only checkpoint/evidence refresh | Low by file type, overlapping by content | Close or reconcile, do not merge as-is | Overlaps the checkpoint lane now covered by PR #208 and PR #209; also adds a not-run route-smoke evidence placeholder that should be reconciled before merge. |
| #206 | `docs: refresh checkpoint after pr204` | Draft docs-only checkpoint refresh | Low by file type, overlapping by content | Close or reconcile, do not merge as-is | Duplicates the post-PR #204 checkpoint refresh intent now covered by PR #208 and PR #209; reconcile before merge. |
| #207 | `docs: refresh checkpoint after pr204` | Draft docs-only checkpoint refresh | Low by file type, overlapping by content | Close or reconcile, do not merge as-is | Duplicates the post-PR #204 checkpoint refresh intent now covered by PR #208 and PR #209; reconcile before merge. |
| #210 | `docs: refresh checkpoint after pr209` | Draft docs-only checkpoint refresh | Low by file type, stale by content | Close, update, or reconcile; do not merge as-is | Superseded by merged PR #211 and PR #212 and should not merge over newer queue/status wording without maintainer review. |
...
5. PR #205: draft checkpoint/evidence refresh after PR #204; reconcile or close because it overlaps PR #208 and PR #209.
6. PR #206: draft checkpoint refresh after PR #204; reconcile or close because it overlaps PR #208 and PR #209.
7. PR #207: draft checkpoint refresh after PR #204; reconcile or close because it overlaps PR #208 and PR #209.
8. PR #210: draft checkpoint refresh after PR #209; reconcile, update, or close because it is superseded by merged PR #211 and PR #212.
...
12. PR #211: merged as docs-only checkpoint refresh after PR #210.
13. PR #212: merged as docs-only checkpoint refresh after PR #211.
...
6. Close, update, or reconcile PR #210 because PR #211 and PR #212 have already recorded newer checkpoint lanes.
