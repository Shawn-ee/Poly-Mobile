...
This document records the current open PR review queue after autonomous review of PR #25, PR #134, PR #135, PR #154, stale docs-only PR #177, superseded draft docs-only PR #192, stale draft docs-only PR #198, merged checkpoint refreshes through PR #200, merged route-smoke preparation PR #197, and merged open PR queue refresh PR #201 on `dev`.
...
| #177 | `docs: refresh UI post-merge state` | Docs-only state refresh | Low by file type, stale by content | Close or update, do not merge as-is | Targets older checkpoint `8db1fd7`; current `dev` is `d08f95c` and includes later state-refresh docs through PR #201. |
| #192 | `docs: refresh autonomous checkpoint after pr191` | Draft docs-only checkpoint | Low by file type, stale by content | Close or update, do not merge as-is | Superseded by merged PR #193 and reflected in later queue/checkpoint refreshes through PR #201 on current `dev` checkpoint `d08f95c`. |
| #198 | `docs: refresh checkpoint after pr196` | Draft docs-only checkpoint | Low by file type, stale by content | Close or update, do not merge as-is | Superseded by merged PR #199, PR #200, PR #197, and PR #201 on current `dev` checkpoint `d08f95c`. |
...
4. PR #198: stale draft docs-only checkpoint superseded by PR #199, PR #200, PR #197, and PR #201; close as superseded or update from current `dev`.
...
4. Close or update PR #198 so its superseded checkpoint wording does not merge over PR #199/#200/#197/#201-era docs.
