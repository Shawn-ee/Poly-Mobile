...
| #212 | Auto-merged | Docs-only checkpoint refresh after PR #211; no runtime code, tests, package/workflow changes, browser run, screenshots, fixtures, wallet, order, bot/reference, or production data. |
...
| #210 | Do not merge as-is | Draft checkpoint refresh after PR #209 is superseded by merged PR #211 and PR #212. Close, update, or reconcile to avoid stale/overlapping state docs. |
...
- `agent/current-dev-checkpoint-after-pr210` was selected because current `dev` contains merged PR #209 and open draft PR #210 is another overlapping checkpoint refresh that should not merge as-is.
