...
Last refreshed from `main` evidence after `npm run mobile:one-event-live-runtime:provider-secret`, `npm run mobile:live-runtime-audit-gate`, `npm run mobile:internal-tester-readiness-gate`, and fresh S23 proof in `docs/mobile/harness/cycle-ZCD-s23-live-event-proof/cycle-ZCD-S23-LIVE-odds-api-s23-visible-flow.json`. The current committed tester gate includes ordered runtime audit, source-aware sportsbook exchange readiness, operator snapshot stages, and S23 close-position Max evidence for the current Argentina vs. England runtime event.
...
| Support one real upcoming soccer event locally | Argentina vs. England is the selected one-event runtime target with backend-owned sportsbook market/outcome identity. | P0 pass | `docs/mobile/harness/odds-api-live-runtime/live-runtime-completion-audit-summary.redacted.json`; `docs/mobile/harness/odds-api-live-runtime/one-event-runtime-status-summary.redacted.json`; `docs/mobile/harness/odds-api-live-runtime/one-event-cached-restore-summary.redacted.json` |
| Prove mobile can trade that event end-to-end | S23 proof covers Home -> Event Detail -> line market -> ticket -> buy -> Portfolio -> close-position cashout/sell -> History for Argentina vs. England. Current phone-side cashout-Max evidence confirms close-position sell mode, owned-share Max, and no Yes/No selector. | P0 pass | `docs/mobile/harness/cycle-ZCD-s23-live-event-proof/cycle-ZCD-S23-LIVE-odds-api-s23-visible-flow.json`; `docs/mobile/screenshots/cycle-ZCD-s23-live-event-proof/`; `docs/mobile/audits/cycle-ZCD-s23-live-event-proof.md` |
...
| Give internal testers a current handoff | Readiness gate runs the ordered live-runtime audit first, then verifies source-aware sportsbook exchange readiness, then emits an operator snapshot/checklist from backend status. It separates cached trading readiness from short-window live-display odds freshness, reports whether no-quota loops are warm right now, selected-market liquidity, source-aware exchange readiness, and zero P0 gaps. A stopped-loop status can still pass cached internal trading when proven capability and exchange readiness are intact; run the recommended startup command when the tester session needs warm supervisor/result-poller loops. | P0 pass | `docs/mobile/harness/odds-api-live-runtime/internal-tester-readiness-gate-summary.redacted.json`; `docs/mobile/harness/odds-api-live-runtime/mobile-internal-exchange-readiness-summary.redacted.json`; `docs/mobile/harness/odds-api-live-runtime/internal-tester-operator-snapshot.redacted.json`; `docs/mobile/harness/odds-api-live-runtime/one-event-runtime-status-summary.redacted.json`; `docs/mobile/INTERNAL_TESTER_OPERATOR_HANDOFF.md`; `docs/mobile/audits/cycle-ZBZ-internal-exchange-readiness-gate.md`; `docs/mobile/audits/cycle-ZBT-internal-tester-readiness-gate.md`; `docs/mobile/audits/cycle-ZBU-watchdog-proof-refresh.md`; `docs/mobile/audits/cycle-ZBV-cached-runtime-warm-restart.md`; `docs/mobile/audits/cycle-ZBW-live-provider-refresh-pulse.md`; `docs/mobile/audits/cycle-ZBX-operator-handoff-clarity.md` |
