...
25. To audit the whole one-event live-runtime phase, run `npm run mobile:one-event-phase-audit`.
26. Do not settle automatically unless official result input and admin review are added.
