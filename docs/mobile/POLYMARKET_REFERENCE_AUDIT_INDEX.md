...
| --- | --- | --- | --- | --- | --- | --- |
| Game page | `docs/mobile/audits/game-page.md` | Cycle AJ focused P0 pass for logged-in World Cup game page and scrolled compact match header | Samsung S23 / logged-in Polymarket Android app | Samsung tablet / Holiwyn Expo Go | Pass | Covers Live tab entry, game top, chart tap, group toggle, scrolled Game Lines, compact header, ticket, chat, share/book, props, rules, and lower-page proof. |
