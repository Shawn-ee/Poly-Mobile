...
| Trade ticket | `docs/mobile/audits/trade-ticket.md` | Cycle AG P0 pass for focused first-view density and advanced-details behavior; Cycle AH adds native tall-sheet/full-page follow-up gap | Samsung S23 / Polymarket Android app and mobile web | Samsung tablet / Holiwyn Expo Go | Pass | Focused ticket first view, amount-to-win state, functional settings/details toggle, selected outcome carry-through, native location gate, and web view-only gate. |
