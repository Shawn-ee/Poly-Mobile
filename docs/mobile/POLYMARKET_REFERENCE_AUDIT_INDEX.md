...
| Trade ticket | `docs/mobile/audits/trade-ticket.md` | Cycle Z P0 pass for focused game-page ticket scope | Samsung S23 / Polymarket mobile web | Samsung tablet / Holiwyn Expo Go | Pass | Focused ticket open, selected line/outcome carry-through, amount chips, amount calculation, and swipe-submit readiness. |
