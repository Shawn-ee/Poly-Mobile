...
Generated: 2026-07-15 after the internal tester readiness gate refresh.
...
- Current selected market id: `38664599-1911-40b4-9c57-382498da8efb`
...
- Latest live provider refresh: the current Argentina vs. England live-provider pulse spent 13 credits, left 229 requests remaining, and kept the provider secret out of committed artifacts.
...
- Settlement: disposable and clone settlement execution are proven; active Argentina vs. England settlement has not executed.
...
- ZCD audit note: `docs/mobile/audits/cycle-ZCD-s23-live-event-proof.md`
- Latest live refresh audit note: `docs/mobile/audits/cycle-ZBW-live-provider-refresh-pulse.md`
...
2. Confirm Home shows Argentina vs. England.
