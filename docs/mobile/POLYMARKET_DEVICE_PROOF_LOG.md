...
| 2026-07-13 | S23CASHOUTMAIN | Spain vs France close-position cashout proof | Internal Local MVP retail flow; no new Polymarket reference action because this cycle verifies the reported Holiwyn runtime cashout bug on the current S23 app bundle | Samsung S23 `SM-S911U1`, device `adb-R3CW20LFMLW-7OpoO6._adb-tls-connect._tcp`, Expo Go server mode, backend `http://127.0.0.1:3002`, mobile API `http://172.16.200.14:3002`, Expo proof port `8289` | Summary: `docs/mobile/harness/cycle-S23CASHOUTMAIN-spain-france-cashout/cycle-S23CASHOUTMAIN-odds-api-s23-visible-flow.json`; cashout screenshot/XML: `docs/mobile/screenshots/cycle-S23CASHOUTMAIN-spain-france-cashout/cycle-S23CASHOUTMAIN-cashout-ticket-ready.png`, `docs/mobile/harness/cycle-S23CASHOUTMAIN-spain-france-cashout/cycle-S23CASHOUTMAIN-cashout-ticket-ready.xml`; audit: `docs/mobile/audits/cycle-S23CASHOUTMAIN-spain-france-cashout.md` | Pass | The real S23 path shows close-position mode, `43.1 shares available`, `cashout-max-owned-shares`, no active Yes/No selector, successful sell, and Portfolio History update. No wallet-sized `$9000`/`$10000` cashout amount appeared. |
| 2026-07-11 | WH | Trade Ticket header simplification | Product reference from Polymarket-style compact amount-entry ticket screenshots and prior logged-in ticket audits; no new Polymarket app swipe because this cycle closes the already-documented Holiwyn header clutter/selection-label gap | Samsung S23 `SM-S911U1`, device `adb-R3CW20LFMLW-7OpoO6._adb-tls-connect._tcp`, Expo Go server mode, backend `http://127.0.0.1:3002` | Summary: `docs/mobile/harness/cycle-WH-ticket-header-simplification/cycle-WH-current-mvp-s23-visible-flow.json`; ticket screenshot/XML: `docs/mobile/screenshots/cycle-WH-ticket-header-simplification/cycle-WH-current-mvp-ticket-ready.png`, `docs/mobile/harness/cycle-WH-ticket-header-simplification/cycle-WH-current-mvp-ticket-ready.xml` | Pass | Ticket header shows the selected line `Argentina Over 1.5`, the extra visible `Buy Argentina Over 1.5` badge is removed, and hidden audit-only mode metadata remains. |
...
- Device: Samsung S23 `adb-R3CW20LFMLW-7OpoO6._adb-tls-connect._tcp` (`SM-S911U1`).
- Scope: Local MVP filled-position cashout/sell lifecycle.
- Result: Pass.
- Flow proven: Home -> Live -> Event Detail -> Spread `1.5` / `Egypt +1.5` -> Trade Ticket -> swipe buy -> filled Portfolio position -> Cash out/Sell ticket -> swipe sell -> Portfolio History sold activity.
- Evidence:
  - `docs/mobile/harness/cycle-XI-cashout-sell-s23-flow/cycle-XI-current-mvp-s23-visible-flow.json`
  - `docs/mobile/harness/cycle-XI-cashout-sell-s23-flow/cycle-XI-current-mvp-line-cashout-ticket.xml`
  - `docs/mobile/harness/cycle-XI-cashout-sell-s23-flow/cycle-XI-current-mvp-line-cashout-history.xml`
  - Screenshots under `docs/mobile/screenshots/cycle-XI-cashout-sell-s23-flow/`
- Key assertions: `filledPositionVisible`, `cashoutTicketOpened`, `cashoutSellSubmitted`, `cashoutHistoryVisible`, `ticketPreservesLine`, and `orderbookHidden` passed.
- Limitations: this is still a contract-fixture fake-token sell/cashout flow. Provider-backed sell/cashout proof remains P1 until provider-backed match/line markets are locally tradable.
...
- Device: Samsung S23 `SM-S911U1` (`adb-R3CW20LFMLW-7OpoO6._adb-tls-connect._tcp`).
- Flow: Home -> Event Detail -> Totals `Over 2.5` -> Trade Ticket -> fake-token order -> Portfolio History.
- Result: pass.
- Evidence: `docs/mobile/harness/cycle-WF-line-family-s23-proof/cycle-WF-current-mvp-s23-visible-flow.json`; screenshots/XML under `docs/mobile/screenshots/cycle-WF-line-family-s23-proof/` and `docs/mobile/harness/cycle-WF-line-family-s23-proof/`.
- Key assertions: `lineMarketGroupKey=totals`, `lineValue=2.5`, `lineOutcomeLabel=Over 2.5`, `filledHistoryVisible=true`, `ticketPreservesLine=true`, `orderbookHidden=true`.
