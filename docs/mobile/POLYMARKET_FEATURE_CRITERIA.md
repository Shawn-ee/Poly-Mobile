...
| --- | --- | --- | --- | --- |
| Live event detail | `docs/mobile/audits/live-event-detail.md` | Verified for Cycle AN focused live-detail UI and backend-shaped fixture scope | P1 real backend routes/schema for live market groups, chart history, live stats, orderbook depth, and live order identity remain active structural work | Pass |
