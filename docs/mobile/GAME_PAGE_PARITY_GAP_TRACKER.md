...
| LMVP-GP-P1-03 | More closed/suspended/unavailable market states need visible Android proof. | Verified for unavailable ticket | Cycle VX proves the deterministic unavailable Trade Ticket state on Samsung S23 with visible `Market unavailable` and disabled side/preset/keypad/swipe submit controls. |
