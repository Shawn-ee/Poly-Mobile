...
Generated: 2026-07-11T23:56:36.032Z
...
| dod-temporary-sportsbook-provider-bridge | partial | Temporary sportsbook provider bridge is available for Local MVP testing without claiming Polymarket-backed parity. | The temporary sportsbook provider bridge is missing, stale, or not fully proven. This does not block Local MVP readiness but should be recovered before using sportsbook-derived markets for manual testing. |
