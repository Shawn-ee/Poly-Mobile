...
| --- | --- | --- | ---: | --- | --- | --- | --- |
| Current live game page Book-selected order to Portfolio/history lifecycle | Cycle ED-C | Fail until integrated proof; PM-GAP-081 opened | 10 | P1 broader real provider-backed line-family lifecycle breadth, open/cancel/fill status breadth, production confirmation recapture, immutable selection snapshots; P2 Portfolio/history visual/motion polish | Reused DQ-C Samsung S23 official Polymarket Book/orderbook and location-gated ticket reference; provider/lifecycle baselines from DN/DO/DX; gate: `docs/mobile/audits/cycle-ed-c-book-order-portfolio-gate.md` | No ED Holiwyn proof collected by Agent C. Future placeholders: `docs/mobile/harness/cycle-ED-integrated-book-order-portfolio/cycle-ED-book-order-portfolio-proof.json`; screenshots/XML under `docs/mobile/screenshots/cycle-ED-integrated-book-order-portfolio/` and `docs/mobile/harness/cycle-ED-integrated-book-order-portfolio/`; backend route/data proof `docs/mobile/harness/cycle-ED-A-book-order-portfolio-backend-proof.json` | ED requires one integrated Book-origin lifecycle: live page Book-selected market/line/outcome -> ticket -> fake-token order submit -> Portfolio open order/open position -> activity/history. Backend-only or screenshot-only proof cannot pass; the same selected identity must be visible on Android and proven in backend order/portfolio/history data. |
