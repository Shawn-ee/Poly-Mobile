...
| GP-P0-18 | Save/book and share controls are present and tappable without breaking the page. | Smoke taps/opens and dismisses share or verifies control existence if native share cannot be automated; screenshot/XML captures controls. |
