...
try {
  ...
  if ($Deep) {
    ...
    if ($LocalMvpSimpleTradeFlow) {
      ...
      Assert-HierarchyContains -Path $mvpTicketHierarchy -Expected (@("trade-ticket", "ticket-retail-reference-layout", "ticket-body-rounded-above-swipe", "ticket-keypad-swipe-separated", "ticket-swipe-area-fixed-bottom", "ticket-s23-keypad-clearance", "ticket-dark-keypad-panel-fixed-clearance", "ticket-red-footer-s23-reference-tightened", "ticket-retail-order-header", "ticket-settings-state-closed", "Mexico vs. Ecuador", "ticket-selection-line", "Yes - MEX -2.5 1H", "ticket-selected-outcome-choice", "ticket-order-review", "ticket-identity-preserved", "ticket-line-2.5", "ticket-period-1st Half", "ticket-preset-25", "ticket-preset-50", "Choose an amount") + $mvpTicketExpected)
      ...
      Assert-HierarchyContains -Path $mvpTicketReadyHierarchy -Expected ($mvpReadyExpected + @("ticket-s23-keypad-clearance", "ticket-red-footer-s23-reference-tightened", "swipe-submit-gesture-required", "swipe-submit-tap-disabled", "swipe-submit-handle-progress-motion", "swipe-submit-handle-progress-animated", "swipe-submit-handle-long-travel", "swipe-submit-handle-s23-visible-travel", "swipe-submit-state-idle", "swipe-submit-handle") + $mvpActiveTicketExpected)
