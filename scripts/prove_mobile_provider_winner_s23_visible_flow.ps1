...
try {
  ...
  Assert-NotContains -Path $detailTopXml -Unexpected @("event-detail-price-chart", "chart-source-polymarket-clob-prices-history", "chart-status-ready", "chart-status-refresh_due", "chart-status-stale", "chart-status-unavailable")
